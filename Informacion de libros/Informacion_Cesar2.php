...
<br><br>
  <div class="container">
    ...
    <div class="imagen">
      ...
      <a href="../Informacion de libros/Resumenes de Libros/Resumen_Paco2.php" class="arrow-next">&#8594;</a>
    </div>
  </div>
  ...
  <footer>
    <div class="content">
      ...
      <div class="link-boxes">
        ...
        <form class="box input-box" action="../Prestamo/Resumen1/4paco.php" method="POST">
