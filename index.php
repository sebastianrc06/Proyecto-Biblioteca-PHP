...
<body>
  <header>
    ...
    <nav>
    <ul>
        <li><a href="./Catalogo/index2.php">Catálogo</a></li>
        <li><a href="#">Libros</a></li>
        <li><a href="#">Cuenta</a></li>
        <li><a href="Iniciar_sesion/iniciar_sesion_index.php">Iniciar sesión</a></li>
      </ul>
    </nav>
  ...
  <footer>
    <div class="content">
      ...
      <div class="link-boxes">
        ...
        <form class="box input-box" action="Prestamo/2Prestamo.php" method="POST">
